<template>
  ...
  >
    ...
    >
      <!-- Card de Login -->
      <div
        class="flex content-center flex-wrap text-center justify-center"
        v-if="!isCadastro"
      >
        ...
        <div class="flex  flex-wrap flex-col">
          <button
            class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-1 px-4 rounded-lg mt-2 ml-10"
            @click="fazerLogin"
          >
            Entrar
          </button>
